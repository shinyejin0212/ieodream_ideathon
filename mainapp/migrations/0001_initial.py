# Generated by Django 3.2.5 on 2021-08-13 02:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_user_set', models.ManyToManyField(blank=True, related_name='likes_user_set', through='mainapp.Like', to=settings.AUTH_USER_MODEL)),
                ('writer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
